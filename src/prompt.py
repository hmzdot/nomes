...
<action_name>(param1=type1, param2=type2, ...)</action_name>
...
print("Hello, world!")
```
You: <execute_shell_command>(command="python3 -c 'print(\"Hello, world!\")'")</execute_shell_command>

===

Available actions: execute_shell_command(command=str) -> str
Context: <execute_shell_command>(command="python3 -c 'print(\"Hello, world!\")'") => Hello, world!.</execute_shell_command>
...
You: <execute_shell_command>(command="ls")</execute_shell_command>

===

Available actions: execute_shell_command(command=str) -> str
Context: <execute_shell_command>(command="ls") => file1.txt, file2.txt, file3.txt.</execute_shell_command>
